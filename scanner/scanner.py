...
class Scanner:
    ...
    async def scan(self, url: str) -> tuple[list[dict], bool, bool, str]:
        """
        Загрузить страницу по URL и вернуть (violations, robots_warning, waf_blocked, blocked_excerpt).

        robots_warning=True если robots.txt ограничивает доступ (Вариант B).
        waf_blocked=True если WAF вернул challenge-страницу — violations не анализируются.
        ...
        :return: (список нарушений, robots_warning, waf_blocked, blocked_excerpt)
        """
